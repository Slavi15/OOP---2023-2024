...
Rectangle::Rectangle(int x1, int y1, int x2, int y2) : Shapes(4, ShapesType::RECTANGLE)
{
	setPoint(x1, y1, 0);
	setPoint(x2, y2, 2);
...
Rectangle::Rectangle(const Point& p1, const Point& p2) : Shapes(4, ShapesType::RECTANGLE)
{
	setPoint(p1, 0);
	setPoint(p2, 2);
